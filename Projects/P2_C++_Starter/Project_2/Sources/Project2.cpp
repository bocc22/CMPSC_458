...
int main()
{
	...
	{
		"../Project_2/Media/skybox/CosmicCoolCloudRight.hdr",
		"../Project_2/Media/skybox/CosmicCoolCloudLeft.hdr",
		"../Project_2/Media/skybox/CosmicCoolCloudTop.hdr",
		"../Project_2/Media/skybox/CosmicCoolCloudBottom.hdr",
		"../Project_2/Media/skybox/CosmicCoolCloudBack.hdr",
		"../Project_2/Media/skybox/CosmicCoolCloudFront.hdr"
	};
	unsigned int cubemapTexture = loadCubemap(faces);

	// init heatmap
	Heightmap heightmap("../Project_2/Media/heightmaps/hflab4.jpg");
	unsigned int heightmap_texture = loadTexture("../Project_2/Media/textures/GrassUV02.png");
	...
	unsigned int track_texture = loadTexture("../Project_2/Media/textures/wall.jpg");
